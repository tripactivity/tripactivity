                                ...
                                <div class="yj_product_details_div_cc">
                                    ...
                                    <div class="yj_product_details_div_ee">
                                        ...
                                        <div class="yj_product_details_div_ff">
                                            ...
                                            입실시간 ${ac_roomDetail.ac_s_startTime} ~ 퇴실시간 ${ac_roomDetail.ac_s_endTime}
                                        </div>
                                    </div>
                                </div>
...
<article class="yj_product_details_section_cc"> 
    ...
    <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper mySwiper2">
        ...
        <c:forEach items="${ac_enrollDetail2}" var="image" begin="0" end="10">
        	<div class="yj_detailMain swiper-slide"  data-ac_productnum="${image.imageList[i].ac_ProductNum}" data-path="${image.imageList[i].uploadPath}" data-uuid="${image.imageList[i].uuid}" data-filename="${image.imageList[i].fileName}">
          	 	<img />
       		</div>
    ...
    <div thumbsSlider="" class="swiper mySwiper">
        ...
        <c:forEach items="${ac_enrollDetail2}" var="image">
        	<div class="yj_detailThumbs swiper-slide"   data-ac_productnum="${image.imageList[i].ac_ProductNum}" data-path="${image.imageList[i].uploadPath}" data-uuid="${image.imageList[i].uuid}" data-filename="${image.imageList[i].fileName}">
            	<img />
        	</div>
        	<c:set var="i" value="${i+1}"/>
        </c:forEach>
			...
			<c:if test="${ac_enrollDetail.ac_Kind eq 2}">
				<div class="yj_room">
					<p class="yj_pic_view"  data-ac_roomnum="${room.imageList[0].ac_roomNum}" data-path="${room.imageList[0].uploadPath}" data-uuid="${room.imageList[0].uuid}" data-filename="${room.imageList[0].fileName}">
						<img class="yj_lazy" alt="금천 호텔 트리플8" style="display: inline;">
					</p>
